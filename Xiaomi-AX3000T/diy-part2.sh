...
grep -nE 'Xiaomi Mi Router AX3000T \(stock layout\)|Xiaomi Mi Router AX3000T$' target/linux/mediatek/files-5.4/arch/arm64/boot/dts/mediatek/mt7981-xiaomi-mi-router-ax3000t-stock.dts
